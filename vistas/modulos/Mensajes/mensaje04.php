<?php 
// Mensaje de confirmacion solicitud de Registro.
...
<div style=" 
      ...
      <h2 style="text-align:center; color:white">
         Su solicitud de Registro fue enviada con exito. A la Brevedad recibira un email con los pasos a seguir para completar el Registro.
         <br />
         <br />
