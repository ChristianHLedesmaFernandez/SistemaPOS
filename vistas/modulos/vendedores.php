              ...
              echo '                     
                      ...
                      <td align="center">
                        <div class="btn-group">                
                          ...
                          <button class="btn btn-danger"><i class="fa fa-times btnEliminarUsuario" idUsuario="'. $value["id"] .'" fotoUsuario="'. $value["foto"] .'" usuario="'. $value["usuario"] .'" perfil="vendedores"></i></button>
                        </div>
                      </td>
                    </tr>';           
            }
          ...
          <div class="box-body">
            ...
            <div class="form-group" id="usuario">
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="text" id="nuevoUsuario" name="nuevoUsuario" placeholder="Ingresar usuario" required>              
              </div>            
            </div>
            ...
            <div class="form-group" id="correo">
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="text" id="nuevoEmail" name="nuevoEmail" placeholder="Ingresar Correo Electronico" required>
              </div>
            </div>
            <!-- Ingresar Contraseña -->
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <div class="input-group"> 
                ...
                <input type="hidden" id="perfilActual" name="perfilActual" value="Vendedor">
...
<!-- Fin Agregar Usuario --> 
<?php  
 $borrarVendedor = new ControladorUsuarios();
 $borrarVendedor -> ctrBorrarUsuario();  
?>